...
//
//  Created by Macbook Pro on 23/3/24.
//
...
class ErrorLoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let errorButton = NSLocalizedString("ErrorButtonLogin", comment: "Boton volver a login")
        
        
        super.viewDidLoad()
        //View error in label
        self.lblError.text = errorText
        self.buttonBack.setTitle(errorButton,  for: .normal)
